...
| 场景 | 文档 |
|------|------|
| 入门 | [01](./01-project-overview.md) [02](./02-architecture.md) [03](./03-tensor-graph.md) |
| 调度/内存 | [04](./04-backend-scheduler.md) [05](./05-memory-alloc.md) |
| 量化/GGUF | [06](./06-quantization.md) [07](./07-gguf-format.md) |
| Backend | [08](./08-backend-cpu.md) [09](./09-backend-gpu.md) [10](./10-other-backends.md) |
| 进阶 | [14](./14-ggml-opt-threading.md) [15](./15-metal-vulkan-deep.md) |
| llama 集成 | [13](./13-llama-cpp-integration.md) |

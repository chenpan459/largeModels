...
1. 本文 → [02-整体架构.md](./02-整体架构.md) → [03-张量模型与计算图.md](./03-张量模型与计算图.md)
2. 推理内核：[04-Backend抽象与调度器.md](./04-Backend抽象与调度器.md) → [05-内存分配器.md](./05-内存分配器.md) → [06-量化系统.md](./06-量化系统.md) → [07-GGUF文件格式.md](./07-GGUF文件格式.md)
3. 性能：[08-CPU后端.md](./08-CPU后端.md) → [09-GPU后端.md](./09-GPU后端.md) → [11-构建系统.md](./11-构建系统.md)
4. 集成：[13-与llama.cpp集成.md](./13-与llama.cpp集成.md)
5. 进阶：[14-ggml-opt与线程系统.md](./14-ggml-opt与线程系统.md) → [15-Metal与Vulkan深度解析.md](./15-Metal与Vulkan深度解析.md)

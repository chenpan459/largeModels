...
- [03-tensor-graph.md](./03-tensor-graph.md) — 张量与图细节
- [04-backend-scheduler.md](./04-backend-scheduler.md) — 调度器完整 API
- [05-memory-alloc.md](./05-memory-alloc.md) — gallocr 生命周期
- [14-ggml-opt-threading.md](./14-ggml-opt-threading.md) — 训练与线程池

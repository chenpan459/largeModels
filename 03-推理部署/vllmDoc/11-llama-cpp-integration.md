...
|-----------|-----------|----------------|
| BlockPool / PagedAttention | [05-kv-cache](./05-kv-cache-paged-attention.md) | 16-kv-cache-memory |
| Continuous Batching / Scheduler | [04-scheduler](./04-scheduler-batch.md) | 17-batch-system |
| GPUModelRunner / decode | [06-model-executor](./06-model-executor.md) | graph/ggml compute |
| OpenAI API Server | [09-entrypoints](./09-entrypoints-api.md) | 12-server |
| 采样 / logits | [13-sampling](./13-sampling-structured-output.md) | sampler chain |
| 量化 | [15-quantization](./15-quantization-catalog.md) | GGUF quant types |
...
- vLLM KV：[05-kv-cache-paged-attention.md](./05-kv-cache-paged-attention.md)
- vLLM API：[09-entrypoints-api.md](./09-entrypoints-api.md)
